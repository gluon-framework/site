...
Gluon's startup time (time it takes to open and load a browser window) is now **halved** compared to the last release, making it one of the fastest frameworks out there. Data from Gluon using Node + Chromium.
